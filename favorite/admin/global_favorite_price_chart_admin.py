...
@admin.register(GlobalFavoritePriceChart)
class GlobalFavoritePriceChartAdmin(admin.ModelAdmin):
    autocomplete_fields = (
        "user",
        "industry",
        "commodity_type",
    ...
    def created_at_shamsi(self, obj: GlobalFavoritePriceChart):
        shamsi = (
    ...
    def updated_at_shamsi(self, obj: GlobalFavoritePriceChart):
        shamsi = (
