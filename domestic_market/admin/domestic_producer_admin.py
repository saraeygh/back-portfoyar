...
@admin.register(DomesticProducer)
class DomesticProducerAdmin(admin.ModelAdmin):
    ...
    def created_at_shamsi(self, obj: DomesticProducer):
        shamsi = (
    ...
    def updated_at_shamsi(self, obj: DomesticProducer):
        shamsi = (
