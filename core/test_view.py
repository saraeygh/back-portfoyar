...
TASKS = {
    ...
    # STOCK
    "410": (get_monthly_activity_report_letter, False),
    "411": (update_market_watch, True),
    "412": (update_stock_full_raw_history, False),
    "413": (update_instrument_info, False),
    "414": (update_instrument_roi, True),
    "415": (stock_value_history, False),
    "416": (stock_option_value_history, False),
    "417": (stock_option_value_change, True),
    "418": (stock_option_price_spread, True),
    "419": (update_stock_adjusted_history, False),
    "420": (update_stock_daily_history, False),
    "421": (update_market_watch_indices, True),
    "422": (monitor_big_money, False),
    # FUTURE
