...
def add_profits(coordinates, profit_factor, remained_day, mid_strike):
    profits = {
        "final_profit": 0,
        "monthly_profit": 0,
        "yearly_profit": 0,
        ...
        if len(cartesians) >= 2:
            for _, row in cartesians[1].iterrows():
                ...
                document = {
                    ...
                    **add_profits(coordinates, abs(profit_factor), remained_day, mid_strike),
                    ...
                    "actions": [
                        ...
                        },
                        {
                            ...
                            **add_action_detail(mid_call_sell, CALL_SELL_COLUMN_MAPPING),
