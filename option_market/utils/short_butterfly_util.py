...
def add_profits(
    ...
    if (
        ...
        left_move = get_deviation_percent(low_strike, base_equity_last_price)
        right_move = get_deviation_percent(high_strike, base_equity_last_price)
...
def short_butterfly(option_data, redis_db_num: int):
                ...
                document = {
                    ...
                    **add_profits(
                    ...
                    "actions": [
                        ...
                        {
                            "action": "خرید",
                            "link": get_link_str(mid_call_buy, "call_ins_code"),
                            **add_details(mid_call_buy, CALL_BUY_COLUMN_MAPPING),
                        },
                        {
                            "action": "خرید",
                            "link": get_link_str(mid_call_buy, "call_ins_code"),
                        ...
                        {
                            "action": "فروش",
                            "link": get_link_str(high_call_sell, "call_ins_code"),
                            **add_details(high_call_sell, CALL_SELL_COLUMN_MAPPING),
                        },
                    ],
                }
