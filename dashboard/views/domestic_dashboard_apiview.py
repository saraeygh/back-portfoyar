...
from core.configs import DOMESTIC_MONGO_DB, DASHBOARD_TOP_5_LIMIT, THIRTY_MINUTES_CACHE

from domestic_market.serializers import DashboardDomesticMeanDeviationSerailizer
...
class DomesticMeanDeviationAPIView(APIView):
